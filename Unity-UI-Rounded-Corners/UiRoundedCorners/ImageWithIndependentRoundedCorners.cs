...
public class ImageWithIndependentRoundedCorners : MonoBehaviour {
	...
	[Range(0, 50)]
	public float coeffx = 10;
	[Range(0, 50)]
	public float coeffy = 10;
	[Range(0, 50)]
	public float coeffz = 10;
	[Range(0, 50)]
	public float coeffw = 10;
	...
	private void Refresh(){
		if (notUseX)
			coeffx = Screen.width / 10;
		if (notUseY)
			coeffy = Screen.width / 10;
		if (notUseZ)
			coeffz = Screen.width / 10;
		if (notUseW)
			coeffw = Screen.width / 10;

		r = new Vector4(Screen.width / coeffx - 10, Screen.width / coeffy - 10, Screen.width / coeffz - 10, Screen.width / coeffw - 10);
